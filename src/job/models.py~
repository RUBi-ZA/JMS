...
class StageType(models.Model):
	StageTypeID = models.AutoField(primary_key=True)
...
class ParameterType(models.Model):
	ParameterTypeID = models.AutoField(primary_key=True)
	ParameterTypeName = models.CharField(max_length=30, db_column='ParameterName')
...
class Job(models.Model):
	...
	Workflow = models.ForeignKey(Workflow, db_column='WorkflowID', related_name='Jobs')
...
class JobStage(models.Model):
	...
	Stage = models.ForeignKey(Stage, db_column='StageID', related_name='JobStages')
